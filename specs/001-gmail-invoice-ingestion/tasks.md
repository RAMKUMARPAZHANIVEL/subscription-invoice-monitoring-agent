...
- [x] T029 [US1] Add `GET /invoices` and `GET /invoices/:id` routes per `contracts/http-api.md` in
...
- [x] T033 [US2] Add the `GET /processing-history` route per `contracts/http-api.md` in
...
- [x] T034 [P] [US3] Integration test: a failing email does not abort the rest of the run
