...
| Category               | Options                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| AI extraction provider | `claude` (default) or `bedrock`, set via `INVOICE_EXTRACTION_PROVIDER` — this is the **authoritative** selector for which extraction implementation runs; `GATEWAY_URL` never overrides it. **Both routes happen to call the CoreValue AI gateway** (`GATEWAY_URL`, default `https://gateway.corevalue.dev`) using `COREVALUE_API_KEY` — `bedrock` uses the AWS Bedrock Runtime `InvokeModelCommand` shape against that gateway endpoint rather than talking to AWS directly with native AWS credentials. That shared gateway host is transport configuration only, not part of provider selection. `ANTHROPIC_API_KEY` is only used as a fallback Anthropic SDK credential if `COREVALUE_API_KEY` is unset. |
